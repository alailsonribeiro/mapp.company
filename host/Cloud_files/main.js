! function (t) {
	function e(e) {
		for (var s, r, o = e[0], f = e[1], h = e[2], l = 0, c = []; l < o.length; l++) r = o[l], a[r] && c.push(a[r][0]), a[r] = 0;
		...
		var f = "[data-range-slider]",
			...
			u = function () {
				...
				return e = t, (i = [{
					key: "cacheDOM",
					value: function (t) {
						this.container = $(t), this.sliderContainer = this.container.find(f), this.valueSelector = this.container.find(d), this.input = this.container.find(l), this.priceSelector = this.container.find(h)
					}
				}, {
					key: "initPlugin",
					value: function () {
					...
					value: function (t) {
						var e = t[0],
							i = this.sliderPips.parent().find('[data-value="' + e + '"]');
						this.sliderPips.parent().find(".is-active").removeClass("is-active"), i.addClass("is-active")
					}
				}, {
					key: "updatePrice",
					value: function (t) {
						if (this.customValues) this.activePrice = this.customValues[t[0]].price, this.priceSelector.text(this.activePrice.toFixed(2));
						else {
	...
	513: function (t, e, i) {
				...
				$("[data-logo]").each(function () {
					...
					$(this).mouseenter(function (e) {
						! function (t) {
							var e = !1;
							if (t.length) {
								var i = t.find("[data-logo-dark-blue]"),
									s = t.find("[data-logo-light-blue]");
								e || (e = !0, Object(l.a)({
									targets: i[0],
									d: [{
										value: [c[1], c[2]],
		...
		var H = {
			...
			ddos: {
				...
				init: function () {
					_(this.refs.screen, 0, 8), _(this.refs.wall, 0, 8), _(this.refs.computer, 0, 16), M(this.refs.shield, function (t, e) {
						return 400 + 140 * e
					}), _(this.refs.block, 0, 8), _(this.refs.light, 0, 16), Object(l.a)({
						targets: Y(Array.from(this.refs.arrows)),
						strokeDashoffset: [l.a.setDashoffset, 0],
						delay: 600,
						duration: 600,
						easing: "easeInSine"
					}), M(this.refs.arrowheads, 1200), Object(l.a)({
			...
			firewall: {
				...
				init: function () {
					W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), _(this.refs.clouds, 0, 16), _(this.refs.light, 0, 8), _(this.refs.shield, 0, 8), _(this.refs.wall, 0, 32), Object(l.a)({
		...
		var F = "[data-screens-slider]",
			Z = "[data-screens-slider-wrapper]",
			J = "[data-slider-pagination]",
			X = "[data-slide-to]",
			Q = "[data-prev-slide]",
			G = "[data-next-slide]",
			K = "[data-slide-desc]",
			...
			et = function () {
				...
				return e = t, (i = [{
					...
					key: "showSlideDesc",
					value: function (t) {
						S.is("mobile") || S.is("tablet") ? (t.attr("style", ""), t.css({
							display: "block"
						})) : t.stop().slideDown(450)
					}
				}, {
					key: "hideSlideDesc",
					value: function (t) {
		...
		var at = "[data-ps-strength]",
			nt = "[data-ps-strength-input]",
			rt = "[data-ps-strength-tooltip]",
		...
		var ut = "[data-cookie]",
			...
			mt = function () {
				...
				return e = t, (i = [{
					...
					key: "show",
					value: function () {
						"hidden" != lt.a.get(this.config.cookieName) && this.element.addClass("is-active")
					}
				}, {
					key: "hide",
					value: function () {
						this.element.removeClass("is-active"), lt.a.set(this.config.cookieName, "hidden", {
			...
			At = function () {
				...
				return e = t, (i = [{
					...
					value: function () {
						...
						var i = new Ot.a('[data-range-slider-container="vCPU"]', e),
							s = {
								onUpdate: function (e, i) {
						...
						var a = new Ot.a('[data-range-slider-container="memory"]', s),
							n = {
								onUpdate: function (e, i) {
						...
						var r = new Ot.a('[data-range-slider-container="SSDStorage"]', n),
							o = {
								onUpdate: function (e, i) {
		...
		function Bt(t, e, i) {
			...
			var f = !0,
				...
				d = void 0;
			try {
				for (var l, c = a.entries()[Symbol.iterator](); !(f = (l = c.next()).done); f = !0) {
					var u = It(l.value, 2),
						p = u[0],
						m = u[1];
					if (s = p + 1, m >= o) break
		...
		var Vt = function () {
				...
				return e = t, (i = [{
					key: "cacheDOM",
					value: function () {
						this.storageValue = this.container.find("[data-os-calculator-storage]"), this.bandwidthValue = this.container.find("[data-os-calculator-bandwidth]"), this.monthlyPrice = this.container.find("[data-os-monthly-price]"), this.storagePricePerMonth = this.container.find('input[name="storagePricePerMonth"]').val(), this.bandwidthPricePerMonth = this.container.find('input[name="bandwidthPricePerMonth"]').val()
					}
				}, {
					key: "bindEvents",
					value: function () {}
					...
					value: function () {
						if (this.storageSlider && this.bandwithSlider) {
							var t = 5;
							t += this.storagePricePerMonth * (this.storageSlider.activeValue - this.storageSlider.config.minValue), t += this.bandwidthPricePerMonth * (this.bandwithSlider.activeValue - this.bandwithSlider.config.minValue), this.monthlyPrice.text(t.toFixed(2))
						}
					}
				}]) && $t(e.prototype, i), s && $t(e, s), t
			}(),
			Mt = function () {
				new Vt
			},
				...
				return e = t, (i = [{
					...
					value: function () {
						...
						this.rows.on("click", function (e) {
							...
							t.sortButtons.attr("data-sort-order", ""), "asc" == t.order ? (i.attr("data-sort-order", "desc"), t.order = "desc", t.list.sort("js-price", {
								order: "desc"
							})) : (i.attr("data-sort-order", "asc"), t.order = "asc", t.list.sort("js-price", {
								order: "asc"
							}))
					...
					value: function (t) {
						var e = this,
							i = $(t.currentTarget).closest("[data-row]");
				...
				return e = t, (i = [{
					...
					value: function () {
						...
						this.setDelay(), this.animations = [], this.pins.each(function (e, i) {
							var s = $(i).find("[data-location-pin-animation] > span"),
								a = Object(l.a)({
									targets: [s[0], s[1]],
									scale: 5.8,
									opacity: [.5, 0],
		...
		var le = {
			...
			pricingTable: {
				...
				init: function (t, e) {
					for (var i = 420, s = function () {
							var t = n[a],
								e = $(t),
								s = e.find("[data-speedometer-arrow]"),
								r = s.data("speedometer-arrow"),
								o = e.find("[data-speedometer-speed]"),
								f = e.parent().find("[data-animation-score]"),
								h = f.data("animation-score");
							if (0 == r) return "continue";
							var d = 238 * r / 100,
								c = (87.4986 - 87.4986 * r / 100).toFixed(4),
								u = (Object(l.a)({
									targets: [o[0]],
									strokeDashoffset: [l.a.setDashoffset, c],
									duration: i,
									delay: 0,
			...
			directConnect: {
				...
				init: function () {
					M(this.refs.light, 0), _(this.refs.trees, 300, 16), _(this.refs.centerBlock, 0), _(this.refs.blocks, 600), W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 1e3,
						easing: "easeInSine",
			...
			ipSpace: {
				...
				init: function () {
					M(this.refs.light, 0), W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), _(this.refs.globe), Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 1e3,
						easing: "easeInSine",
					...
					}), M(this.refs.globe, 0), Object(l.a)({
			...
			privateNetworking: {
				...
				init: function (t, e) {
					W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), _(this.refs.buildings, 0, 16), Object(l.a)({
			...
			gaming: {
				...
				init: function (t, e) {
					if (M(this.refs.light, 160), _(this.refs.sideElements, 0, 32), this.refs.topElement.length && (_(this.refs.topElement, 0, 32), _(this.refs.bottomElement, 0, 16), M(this.refs.shadowElement)), _(this.refs.bullets, 0, 16), this.refs.path.length) Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 1e3,
						easing: "easeInSine",
			...
			bareMetal: {
				...
				init: function (t, e) {
					M(this.refs.light, 160), _(this.refs.sideElements, 0, 32), this.refs.topElement.length && (_(this.refs.topElement, 0, 32), _(this.refs.bottomElement, 0, 16), M(this.refs.shadowElement)), Object(l.a)({
			...
			objectStorage: {
				...
				init: function (t, e) {
					_(this.refs.sideElements, 0, 16), M(this.refs.light, 160), _(this.refs.topElement, 0, 32), _(this.refs.bottomElement, 0, 16), M(this.refs.shadowElement), Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 1e3,
						easing: "easeInSine",
			...
			bestPerformance: {
				...
				init: function (t, e) {
					_(this.refs.blocks, 300), _(this.refs.ring, 600), W([this.refs.server[0]], [this.refs.serverTop[0]], [this.refs.serverCenter[0]], [this.refs.serverBottom[0]]), Object(l.a)({
			...
			advancedNetworking: {
				...
				init: function (t, e) {
					W([this.refs.server[0]], [this.refs.serverTop[0]], [this.refs.serverCenter[0]], [this.refs.serverBottom[0]]), W([this.refs.server[1]], [this.refs.serverTop[1]], [this.refs.serverCenter[1]], [this.refs.serverBottom[1]]), _(this.refs.pins, 300), _(this.refs.screen, 0), Object(l.a)({
			...
			fullControl: {
				...
				init: function (t, e) {
					W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), _([this.refs.light[0]], 300, 16), _([this.refs.browser[0]], 300, 8), _(this.refs.browserBody, 300, 32), L(this.refs.key, 0, -8), _(this.refs.keyHole, 0, 8), Object(l.a)({
			...
			automatedScaling: {
				...
				init: function (t, e) {
					_([this.refs.browser[0]], 300, 8), _([this.refs.blocks[0]], 300, 16), _([this.refs.blocks[1]], 300, 24), L(this.refs.scaleTop, 300, -16), L(this.refs.scaleArrows, 300, -8), _(this.refs.scaleBottom, 300, 24), Object(l.a)({
						targets: oe(Array.from(this.refs.arrowBottom)),
						strokeDashoffset: [1093.0572, 0],
						delay: 0,
						duration: 1600,
			...
			localizedPeering: {
				...
				init: function (t, e) {
					L([this.refs.user[0]], 300, -32), L([this.refs.pins[0]], 0, -8), L([this.refs.pins[1]], 0, -16), L([this.refs.pins[2]], 0, -24), L([this.refs.pins[3]], 0, -32), _([this.refs.blocks[0]], 0, 8), _([this.refs.blocks[1]], 0, 16), _([this.refs.blocks[2]], 0, 24), _([this.refs.blocks[3]], 0, 32), Object(l.a)({
			...
			blockStorage: {
				...
				init: function (t, e) {
					W([this.refs.server[0]], [this.refs.serverTop[0]], [this.refs.serverCenter[0]], [this.refs.serverBottom[0]]), W([this.refs.server[1]], [this.refs.serverTop[1]], [this.refs.serverCenter[1]], [this.refs.serverBottom[1]]), Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [934, 0],
						duration: 1e3,
						easing: "easeInSine",
			...
			customISO: {
				...
				init: function (t, e) {
					M(this.refs.disc, 0), Object(l.a)({
						...
						duration: 1e3,
						easing: "easeInSine"
					}), L(this.refs.discTop, 0, -8), _(this.refs.discBottom, 0, 8), _(this.refs.robot, 0, 16), Object(l.a)({
			...
			noNeighbor: {
				...
				init: function (t, e) {
					W([this.refs.server[0]], [this.refs.serverTop[0]], [this.refs.serverCenter[0]], [this.refs.serverBottom[0]]), W([this.refs.server[1]], [this.refs.serverTop[1]], [this.refs.serverCenter[1]], [this.refs.serverBottom[1]]), _(this.refs.user, 0, 16), M(this.refs.bubble, 400, 600), Object(l.a)({
						targets: oe(Array.from(this.refs.lines)),
						strokeDashoffset: [l.a.setDashoffset, 0],
						delay: 400,
						duration: 1e3,
			...
			vultr: {
				...
				init: function (t, e) {
					_(this.refs.centerBlock, 0), _(this.refs.blocks, 600), _(this.refs.users, 0, 32), _(this.refs.trees, 300, 16), Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 1e3,
						easing: "easeInSine",
			...
			ddosMonitoring: {
				...
				init: function (t, e) {
					W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), _(this.refs.shield, 0, 8), _(this.refs.globe, 0, 32), _(this.refs.screen, 0, 16), _(this.refs.barells, 0, 8), Object(l.a)({
						targets: oe(Array.from(this.refs.lines)),
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 640,
						easing: "easeInSine",
			...
			redundancy: {
				...
				init: function (t, e) {
					W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), _(this.refs.user, 0, 32), _(this.refs.serverOffline, 0, 32), _(this.refs.monitor, 0, 32), _(this.refs.light, 0, 16), _(this.refs.block, 0, 8), Object(l.a)({
						targets: oe(Array.from(this.refs.lines)),
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 640,
						easing: "easeInSine",
			...
			reservedIPs: {
				...
				init: function (t, e) {
					...
					_(this.refs.list, 0, -8), M(this.refs.light), L(this.refs.monitor, 0, 8), Object(l.a)({
						targets: oe(Array.from(this.refs.lines)),
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 640,
						easing: "easeInSine",
			...
			fastBenchmarks: {
				...
				init: function (t, e) {
					_(this.refs.usageCenter, 0, 32), _(this.refs.usageLeft, 0, 24), _(this.refs.usageRight, 0, 16), _(this.refs.screen, 0, 8), _(this.refs.cond, 0, 8), Object(l.a)({
			...
			fastCPU: {
				...
				init: function (t, e) {
					_(this.refs.screen, 0, 32), _(this.refs.motherboardLeft, 0, 32), _(this.refs.motherboardRight, 0, 32), _(this.refs.boxLeft, 0, 24), _(this.refs.boxRight, 0, 24), _(this.refs.CPUTop, 0, 24), _(this.refs.CPUBottom, 0, 24), _(this.refs.CPULight, 0, 16), Object(l.a)({
			...
			easyOfIntegration: {
				...
				init: function (t, e) {
					_(this.refs.topElement, 0, 32), _(this.refs.bottomElement, 0, 16), M(this.refs.light, 160), M(this.refs.shadowElement), W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom), Object(l.a)({
						targets: [this.refs.path[0]],
						strokeDashoffset: [934, 0],
						duration: 1e3,
						easing: "easeInSine",
			...
			automaticBackups: {
				...
				init: function (t, e) {
					_(this.refs.box), _(this.refs.folder, 240), _(this.refs.settings, 480), _(this.refs.api, 720), _(this.refs.browser, 960), _(this.refs.pages, 1200), Object(l.a)({
			...
			loadBalancerHiglyAvailable: {
				refs: {},
				beforeInit: function (t, e) {
					this.refs.element = t, this.refs.user = t.find("[data-animation-user]"), this.refs.browser = t.find("[data-animation-browser]"), this.refs.paths = t.find("[data-animation-path]"), this.refs.frontPaths = t.find("[data-animation-front-paths]"), this.refs.cluster = t.find("[data-animation-cluster]"), this.refs.dots = t.find("[data-animation-dot]"), this.refs.clusterBottom = t.find("[data-animation-cluster-bottom]"), this.refs.clusterCenter = t.find("[data-animation-cluster-center]"), this.refs.clusterTop = t.find("[data-animation-cluster-top]"), this.refs.server = t.find("[data-server]"), this.refs.serverTop = t.find("[data-server-top]"), this.refs.serverCenter = t.find("[data-server-center]"), this.refs.serverBottom = t.find("[data-server-bottom]")
				},
				init: function (t, e) {
					W(this.refs.cluster, this.refs.clusterTop, this.refs.clusterCenter, this.refs.clusterBottom), W(this.refs.server, this.refs.serverTop, this.refs.serverCenter, this.refs.serverBottom, 500), _(this.refs.user, 400), _(this.refs.browser, 600), _(this.refs.frontPaths), Object(l.a)({
						targets: oe(Array.from(this.refs.paths)),
						strokeDashoffset: [l.a.setDashoffset, 0],
						duration: 1e3,
						easing: "easeInSine",
					...
					var i = 900,
						...
						n = void 0;
					try {
						for (var r, o = Array.from(this.refs.dots).reverse()[Symbol.iterator](); !(s = (r = o.next()).done); s = !0) {
							M([r.value], i), i += 200
						}
					} catch (t) {
						a = !0, n = t
			...
			customSolutions: {
				...
				init: function (t, e) {
					_(this.refs.user), _(this.refs.infinity, 120), _(this.refs.browser, 340), _(this.refs.pin, 340), _(this.refs.icons, 440), _(this.refs.box, 640), Object(l.a)({
			...
			loadBalancerSecure: {
				refs: {},
				beforeInit: function (t, e) {
					this.refs.element = t, this.refs.connector = t.find("[data-animation-connector]"), this.refs.pipes = t.find("[data-animation-pipe]"), this.refs.browser = t.find("[data-animation-browser]"), this.refs.dots = t.find("[data-animation-dots]").children(), this.refs.dots = t.find("[data-animation-dots]").children(), this.refs.servers = t.find("[data-animation-server]"), this.refs.path = t.find("[data-animation-path]")
				},
				init: function (t, e) {
					_(this.refs.connector, 0, 16), _(this.refs.pipes, 640, 8), _(this.refs.browser, 320), _(this.refs.servers, 480, 16), Object(l.a)({
						targets: [this.refs.path[0]],
					...
					for (var i = 900, s = 0, a = Array.from(this.refs.dots); s < a.length; s++) {
						M([a[s]], i), i += 200
					}
				}
         },
         referralProgram: {
            ...
            beforeInit: function(t, e) {
                this.refs.element = t,
                this.refs.path = t.find("[data-animation-path]"),
                this.refs.topElement = t.find("[data-animation-top]"),
                this.refs.shadowElement = t.find("[data-animation-shadow]"),
                this.refs.sideElements = t.find("[data-animation-left], [data-animation-right]")
            },
            init: function(t, e) {
                (_(this.refs.sideElements, 0, 32),
                this.refs.topElement.length && (_(this.refs.topElement, 0, 32),
                _(this.refs.shadowElement)),
                this.refs.path.length)
                    Object(l.a)({
                        targets: [this.refs.path[0]],
			...
			loadBalancerScalable: {
				refs: {},
				beforeInit: function (t, e) {
					this.refs.element = t, this.refs.connector = t.find("[data-animation-connector]"), this.refs.pipes = t.find("[data-animation-pipe]"), this.refs.browser = t.find("[data-animation-browser]"), this.refs.add = t.find("[data-animation-add]"), this.refs.servers = t.find("[data-animation-server]"), this.refs.light = t.find("[data-animation-light]")
				},
				init: function (t, e) {
					_(this.refs.connector, 0, 16), M(this.refs.light, 0, 600), _(this.refs.browser, 320), _(this.refs.servers, 480, 16), _(this.refs.pipes, 640, 8), L(this.refs.add, 800, -8)
				}
			},
			loadBalancerAPI: {
				refs: {},
				beforeInit: function (t, e) {
					this.refs.element = t, this.refs.bukcet = t.find("[data-animation-bucket]"), this.refs.laptop = t.find("[data-animation-laptop]"), this.refs.mouse = t.find("[data-animation-mouse]"), this.refs.tunel = t.find("[data-animation-tunel]"), this.refs.wheel = t.find("[data-animation-wheel]")
				},
				init: function (t, e) {
					_(this.refs.laptop), _(this.refs.mouse, 160), _(this.refs.bukcet, 320), _(this.refs.wheel, 480), _(this.refs.tunel, 640)
				}
			}
		};
			...
			me = function () {
				...
				return e = t, (i = [{
					...
					value: function () {
						...
						try {
							this.animationType = P()(le[this.config.type]), this.isInitiated = !0, this.animationType.beforeInit(this.element, this.config), setTimeout(function () {
		...
		var we = {
			...
			ke = function () {
				...
				return e = t, (i = [{
					...
					key: "disableSlider",
					value: function () {
						this.swiperInstance.destroy(), this.slider.css({
							visibility: "visible"
						}), this.slider.addClass("is-disabled"), this.nextSlide.addClass("is-disabled"), this.prevSlide.addClass("is-disabled")
					}
				}, {
					...
					value: function (t) {
						if (t != this.activeFilter)
							if (this.activeFilter = t, this.filtersContainer.find(".is-active").removeClass("is-active"), this.filtersContainer.find('[data-filter="'.concat(t, '"]')).parent().addClass("is-active"), "all" != t) {
								var e = [];
		...
		var xe = function () {
			...
			setTimeout(function () {
					...
					var e = $(this).closest("[data-tiles-slider]"),
						i = $(this).closest("[data-screens-slider]"),
						s = i.find("[data-slider-pagination]"),
						a = $(this),
						n = a.data("tiles-slider-item");
					...
					t.preventDefault();
					var e = $(t.currentTarget).data("link-to"),
				...
				function () {
					var t = $("[data-pricing-nav]"),
						e = $("[data-pricing-tabs]");
					if (e.length) {
						var i = A.a.create(e[0], -550);
						$(t).find("a").on("shown.bs.tab", function (t) {
							i.isInViewport || $([document.documentElement, document.body]).stop().animate({
		...
		h.a.initJqueryPlugin(), $(document).ready(function () {
			s.a.initDataSelectors(), r.a.initDataSelectors(), o.a.initDataSelectors(), f.a.initDataSelectors(), a.a.initDataSelectors(), n.a.initDataSelectors(), d.a.initDataSelectors(), h.a.initDataSelectors(), je(), p(), v(), ve(), T(), C.init(), it(), ht(), vt(), Ct(), Pt(), Mt(), Lt(), Rt(), Ft(), Xt(), te(), Se(), Ie(), xe()
		})
	},
	55: function (t, e, i) {
		"use strict";
